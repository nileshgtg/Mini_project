...
table_schema1 = parse_table_schema_from_json(json.dumps(json.load(open("/home/airflow/gcs/dags/schema2.json"))))
table_schema2 = parse_table_schema_from_json(json.dumps(json.load(open("/home/airflow/gcs/dags/schema3.json"))))
table_schema3= parse_table_schema_from_json(json.dumps(json.load(open("/home/airflow/gcs/dags/schema4.json"))))
