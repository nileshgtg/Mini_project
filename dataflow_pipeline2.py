...
table_schema1 = parse_table_schema_from_json(json.dumps(json.load(open("gs://us-central1-nilesh-project1-57d424ca-bucket/dags/schema2.json"))))
table_schema2 = parse_table_schema_from_json(json.dumps(json.load(open("gs://us-central1-nilesh-project1-57d424ca-bucket/dags/schema3.json"))))
table_schema3= parse_table_schema_from_json(json.dumps(json.load(open("gs://us-central1-nilesh-project1-57d424ca-bucket/dags/schema4.json"))))
